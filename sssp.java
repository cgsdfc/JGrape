...
public class sssp extends worker<pairmsg, Integer> {
        ...
        protected void assemble(){
                ...
                HashMap<Integer, Integer> thisresult = new HashMap<>();
        ...
        public ArrayList<HashMap<Integer, Integer>> getfinalresult(){
        ...
        public static void main(String [] args) throws FileNotFoundException {
                ...
                teller t = new teller(ssspworker.getfinalresult(), "simple", "sssp");
                t.write();
        }
